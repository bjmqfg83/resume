...
$("#SendMail").click(() => {
  ...
  // veri
  // namr veri
  var nameVeri = /^[(\u4e00-\u9fa5)|(a-zA-Z)]{3,16}$/;
  var nameRes =  nameVeri.test(name);
  // mail veri
  var mailVeri = /^[\w]{8,16}@(gmail|yahoo).com$/;
  var mailRes =  mailVeri.test(mail);
  // content veri
  if(content.length>0){
    contentRes = true;
  }
  ...
  if (nameRes == true && mailRes == true && contentRes == true) {
